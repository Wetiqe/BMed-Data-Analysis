...
def to_csv_r(df, group_name, arrtribute):
    fname = './cache/{}_{}'.format(group_name,arrtribute)
    df[arrtribute].to_csv(fname,index=None)
    return fname[8:]
...
# useage: robjects.r['perm_matched_t']('pre_HAMD.csv', 'post_HAMD.csv', 8, nreps=10000)
